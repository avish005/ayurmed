                        ...
                        <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12 smt-40 xmt-40">
                            <div class="ht__product__dtl">
                                ...
                                <div class="ht__pro__desc">
                                 ...
                                 <?php
                                    if($cart_show != ''){ ?>
                                        <a class="fr__btn" href="javascript:void(0)" onclick="manage_cart('<?php echo $get_product['0']['id']?>','add')"><i class="fa fa-opencart"></i> Add to cart</a>
                                <?php } ?>
                                <a class="fr__btn" href="javascript:void(0)" onclick="wishlist_manage('<?php echo $get_product['0']['id']?>','add')"><i class="icon-heart icons"></i> Wishlist</a>
                            </div>
                        </div>
                    </div>
                </div>
