...
//stock availability(INVENTORY)
	...
	function productSoldQty($con, $pid){
	...
	function sentInvoice($con, $order_id){
					...
					<td class="email-body" width="100%" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<div class="f-fallback">
								...
								<p>Thanks for using AWPL. This is an invoice for your recent purchase.</p>
											...
											while($row = mysqli_fetch_assoc($res)){
												...
												$html .='<tr>
															<td width="80%" class="purchase_item">
																<span class="f-fallback">'.$row['name'].'</span>
															</td>
															<td class="align-right" width="20%" class="purchase_item">
																<span class="f-fallback">'.$pp.'</span>
															</td>
														</tr>';							
											}
										$html .='                                
		...
		$mail->SMTPSecure="tls";
		$mail->SMTPAuth=true;
		$mail->Username="stunneravi@gmail.com";
		$mail->Password="Avishambhavibestbuddiesforever123#";
		$mail->SetFrom("stunneravi@gmail.com");
