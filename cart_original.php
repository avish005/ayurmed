                                ...
                                <table>
                                    ...
                                    <tbody>
										...
										if(isset($_SESSION['cart'])){
											...
											?>
											<tr>
												<td class="product-thumbnail"><img src="<?php echo PRODUCT_IMAGE_SITE_PATH.$image?>"  /></a></td>
												...
												<td class="product-quantity"><input type="number" id="<?php echo $key?>qty" value="<?php echo $qty?>" onclick="manage_cart('<?php echo $key?>','update')" />
												<span class="not_enough_stock"></span>
												</td>
