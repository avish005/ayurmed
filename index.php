        ...
        <section class="services">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-11 category">
                        <div class="card">
                            <i class="fa fa-question service-icon category"></i>
                            <div class="card-body">
                                <h3 class="card-title">EASY TO GET IN TOUCH</h3><br>
                                <p class="card-text"><a href="tel:1234567890"><i class="fa fa-phone service-icon2"></i> +91-1234567890</a></p>
                                <p class="card-text"><a href="mailto:demomail@demo.com"><i class="fa fa-envelope-open-o service-icon2"></i> demomail@demo.com</a></p><br>
                                <p class="card-text"> For any enquiry against order contact us.</p>
                            </div>
                        </div>
                    </div>
                </div>
